...
- Video 7 dense white clay-slime profile with 29 polished sounds: 20 press/knead sounds and nine short-pull/fold/release sounds.
- Video 8 pink gummy jelly-slime profile with 30 polished sounds: 24 pinch/pop/knead sounds and six pull/fold/release sounds.
- Video 9 white poke-putty profile with 30 sounds split into 13 body-friction and 17 clay snap/suction variations.
- Video 10 orange glossy-slime profile with seven micro-pops and two firm glossy snaps.
- Video 11 green micro-bead floam profile with six body-friction and 16 bead pop/snap variations.
- Pressure-aware same-material mixing for Videos 9-11, with bounded probability, gain, delay, and pitch variation.
...
The Squish Surface can record up to 36,000 input samples and export a JSON file. Each session stores the selected material profile ID. Every sample contains relative time, mode, finger count, pressure, Force Touch stage, movement, spread, intensity, and normalized touch coordinates. Recognized sound gestures are stored as a separate event list.
...
`Open Camera Slime...` uses the built-in camera and Apple's on-device Vision hand-pose request. Select a slime or wax profile to apply its camera-specific gesture thresholds and sound mappings. With `Clear Slime (Video 3)`, holding two open hands far enough apart arms bar-pung; moving both hands quickly downward while keeping the sheet broad seals it. Videos 6-11 apply independent compact press, pull, spread, and relative-pressure thresholds learned from their own references. Video 9 emphasizes deep pokes, Video 10 repeated glossy pokes and folds, and Video 11 precise two-fingertip bead presses. `Pastel Wax Shell Slime (Video 4)` uses two opposing fingertips, convergence speed, pinch, and visible hand compression to infer press, repeated fine-crack, and crush stages. Camera frames are not uploaded or saved by SquishMac. The camera pressure value is a visual estimate, not physical Force Touch pressure. See [the material and gesture catalog](Docs/MATERIAL_GESTURE_CATALOG.md) for every profile's mapping.
...
The general sound packs are generated development placeholders. The Doctor Putty failure pack contains two short clips derived from user-provided video 2. The clear-video-3 packs contain 34 knead/press clips and 6 stretch clips. Video 4 contains 18 exposed-core handling clips plus all six verified opening wax-shell transients: five progressive cracks and one final crush. Video 5 contains 14 compact knead/press clips and six short-pull clips from the white dense putty. Video 6 contains 35 bubble-poke/knead/press clips and seven broad-pull clips; one source-clipped transient was deliberately excluded. Video 7 contains 20 dense press/knead clips and nine short-pull/fold/release clips; one low-confidence voice-like candidate was excluded. Video 8 contains 24 pink jelly pinch/pop/knead clips and six pull/fold/release clips. Videos 9-11 add 61 event-aligned clips split into body and sharper texture pools. Their optional second layer is always from the same reference material and remains quieter than the primary. All reference clips use a conservative peak ceiling, curved boundary fades, voice screening, cross-modal contact review, and a profile-level minimum interval to avoid abrupt or chattering playback. These packs are profile-only. Replace generated placeholders with original or properly licensed recordings before release. A custom folder can also be selected from Settings for impact sounds.
